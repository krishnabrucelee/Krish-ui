    ...
    object.getPandaChart = function() {
        ...
        var pandaChart = {
            ...
            getChartLabelByRangeAndDate : function(rangeId, date) {
                switch (rangeId) {
                case "5m":
                    return pandaChart.getTimeLabels(15, pandaChart.delayType.Seconds, date);
                    break;
                case "15m":
                    return pandaChart.getTimeLabels(60, pandaChart.delayType.Seconds, date);
                    break;
                case "30m":
                    return pandaChart.getTimeLabels(2, pandaChart.delayType.Minutes, date);
                    break;
                case "45m":
                    return pandaChart.getTimeLabels(2, pandaChart.delayType.Minutes, date);
                    break;
                case "1h":
                    return pandaChart.getTimeLabels(5, pandaChart.delayType.Minutes, date);
                    break;
                case "3h":
                    return pandaChart.getTimeLabels(15, pandaChart.delayType.Minutes, date);
                    break;
                case "6h":
                    return pandaChart.getTimeLabels(30, pandaChart.delayType.Minutes, date);
                    break;
                case "12h":
                    return pandaChart.getTimeLabels(1, pandaChart.delayType.Hour, date);
                    break;
                case "24h":
                    return pandaChart.getTimeLabels(2, pandaChart.delayType.Hour, date);
                    break;
                }
            },
            ...
            updateChartMarginByRangeAndIndex : function(rangeId, indexValue, chartIteration, chartContainer) {
                ...
                case "45m":
                    if (chartIteration < 45 && indexValue == 0) {
                        ...
                        selector.css({
                            "margin-left" : -fourtyfiveMinMargin
                        });
                    }
                    break;
                case "1h":
                ...
                case "24h":
                    if (chartIteration < 1440 && indexValue == 0) {
                        ...
                        selector.css({
                            "margin-left" : -twentyFourHourMargin
                        });
                    }
                    break;
                }
 ...
 */
angular.module('homer').factory('monitorService', monitorService);
