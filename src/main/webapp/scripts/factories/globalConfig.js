	...
	appGlobalConfig = {
		...
		networks : {
			name : "http://" + window.location.hostname
					+ ":9090/pandaui/index#/billing/payments"
		},
		sort : {
			column : '',
			descending : false,
		...
		BASE_UI_URL : "http://" + window.location.hostname + ":8081/pandaui/",
		CONTENT_LIMIT : 10,
		VIEW_URL : 'app/views/',
		...
		sessionValues : JSON.parse($window.sessionStorage
				.getItem("loginSession")),
