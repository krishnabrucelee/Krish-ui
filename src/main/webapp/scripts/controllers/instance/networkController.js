 ...
 *
 */
angular.module('homer').controller('networkCtrl', networkCtrl)
...
function networkCtrl($scope, $modal, $state, $window, $stateParams, appService) {
    ...
    $scope.list = function(pageNumber) {
        ...
        var hasGuestNetworks = appService.crudService.list("guestnetwork", $scope.global.paginationHeaders(pageNumber, limit), {
            "limit": limit
        });
