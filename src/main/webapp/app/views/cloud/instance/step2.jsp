...
<div data-ng-if="!showLoaderOffer">
    <div class="row border-content">
        <div class="col-offset-3 col-md-12 col-sm-12">
            <div class="row form-group required" data-ng-class="{ 'text-danger' : instanceForm.computeoffer.$invalid && OfferingSubmitted}">
                <div class="col-md-5 col-xs-5 col-sm-5">
                    <div class="pull-left m-r-xs m-t-xxs" data-ng-show="computes && instance.computeOffering.customized">
                        <a ng-click="computeSlide(); diskSlide();"> <span data-ng-hide="compute" class="pe pe-lg pe-7s-plus"></span> <span data-ng-show="compute" class="pe pe-lg pe-7s-less"></span>
                        </a>
                    </div>
                    <label class="pull-left section-title">
                        <fmt:message key="common.compute.offering" bundle="${msg}" /><span title="<fmt:message key=" common.required " bundle="${msg} " />" class="text-danger font-bold">*</span>
                    </label>
                </div>
                <div class="col-md-6 col-xs-6 col-sm-6">
                    <select required="true" class="form-control form-group-lg" name="computeOffering" ng-change='computeFunction(instance.computeOffering.customized)' data-ng-model="instance.computeOffering" data-ng-class="{'error': instanceForm.computeOffering.$invalid && OfferingSubmitted}" data-ng-options="computeOffering.name group by computeOffering.group for computeOffering in instanceElements.computeOfferingList">
                        <option value="">
                    ...
                    <input required="true" type="hidden" name="computeoffer" data-ng-model="instance.computeOffering.customized" class="form-control" data-ng-class="{'error': instanceForm.computeoffer.$invalid && OfferingSubmitted}">
                </div>
            </div>
        </div>
        <div data-ng-show="compute  && instance.computeOffering.customized">
            <div class="row m-b-xl" data-ng-class="{ 'text-danger' : instanceForm.memory.$modelValue <= 0 && OfferingSubmitted}">
                ...
                <div class="col-md-3 col-sm-3 digit-2-width">
                    <div class="input-group">
                        <input class="form-control" name="memory" valid-number data-ng-min="{{ instance.computeOffer.memory.floor}}" data-ng-max="{{ instance.computeOffer.memory.ceil}}" type="text" data-ng-model="instance.computeOffer.memory.value"> <span class="input-group-addon" id="basic-addon2">MB</span>
                    </div>
                </div>
            </div>
            <div class="row m-b-xl" data-ng-class="{ 'text-danger' : instanceForm.cpuCore.$modelValue <= 0 && OfferingSubmitted}">
                ...
                <div class="col-md-3 col-sm-3 digit-2-width">
                    <div class="input-group">
                        <input valid-number data-ng-min="{{ instance.computeOffer.cpuCore.floor}}" data-ng-max="{{ instance.computeOffer.cpuCore.ceil}}" type="text" class="form-control" name="cpuCore" data-ng-model="instance.computeOffer.cpuCore.value"> <span class="input-group-addon"><fmt:message key="core"
								bundle="${msg}" /></span>
                    </div>
                </div>
            </div>
            <div class="row m-b-xl" data-ng-class="{ 'text-danger' : instanceForm.cpuSpeed.$modelValue <= 1000 && OfferingSubmitted}">
                ...
                <div class="col-md-3 col-sm-3 digit-2-width">
                    <div class="input-group">
                        <input valid-number data-ng-min="{{ instance.computeOffer.cpuSpeed.floor}}" data-ng-max="{{ instance.computeOffer.cpuSpeed.ceil}}" type="text" class="form-control" name="cpuSpeed" data-ng-model="instance.computeOffer.cpuSpeed.value"> <span class="input-group-addon">MHz</span>
                    </div>
                </div>
            </div>
    ...
    <div class="row border-content">
            ...
            <div class="row  form-group">
                <div class="col-md-5 col-xs-5 col-sm-5">
                    <label class="section-title">
                        <fmt:message key="common.disk.offering" bundle="${msg}" />
                    </label>
                </div>
                <div class="col-md-6 col-xs-6 col-sm-6">
                    <select class="form-control input-group" name="storageOffering" data-ng-model="instance.storageOffering" ng-change='diskFunction(instance.storageOffering.name)' ng-options="storageOffering.name for storageOffering in instanceElements.diskOfferingList">
                        <option value="">
        ...
        <div data-ng-show="instance.storageOffering.isCustomDisk">
            <div class="form-group" data-ng-class="{ 'text-danger' : instanceForm.diskSize <= 0 && instanceForm.diskSize.$invalid && formSubmitted}">
                <div class="row">
                    ...
                    <div class="col-md-2 col-xs-12 col-sm-3">
                        <input type="text" required="true" data-ng-min="{{ instance.diskOffer.diskSize.floor }}" data-ng-max="{{ instance.diskOffer.diskSize.ceil}}" class="form-control input-mini" name="diskSize" data-ng-model="instance.diskSize" valid-number="">
                    </div>
                </div>
            </div>
            <div class="" data-ng-class="{ 'text-danger' : instanceForm.diskMinIops.$invalid && formSubmitted}" data-ng-show="instance.storageOffering.isCustomizedIops">
                <div class=" m-b-xl">
                    <div class="col-md-5 col-sm-6">
                        <div class="form-group" data-ng-class="{ 'text-danger' : instanceForm.diskMinIops.$invalid && OfferingSubmitted}">
                            <label class="col-md-6 col-xs-12 col-sm-6 control-label">
                                <fmt:message key="min.iops" bundle="${msg}" /> <span class="text-danger">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6">
                                <input required="true" class="form-control ng-pristine ng-valid ng-touched" type="text" data-ng-model="instance.diskMinIops" valid-number="" name="diskMinIops">
                                <div class="error-area" data-ng-show="instanceForm.diskMinIops.$invalid && OfferingSubmitted">
                                    <i ng-attr-tooltip="{{ instanceForm.diskMinIops.errorMessage || '<fmt:message key=" min.iops.required " bundle="${msg} " />' }}" class="fa fa-warning error-icon"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5 col-sm-6">
                        <div class="form-group" data-ng-class="{ 'text-danger' : instanceForm.diskMinIops.$invalid && OfferingSubmitted}">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input required="true" class="form-control ng-pristine ng-valid ng-touched" type="text" data-ng-model="instance.diskMaxIops" valid-number="" name="diskMaxIops">
                                <div class="error-area" data-ng-show="instanceForm.diskMaxIops.$invalid && OfferingSubmitted">
                                    <i ng-attr-tooltip="{{ instanceForm.diskMaxIops.errorMessage || '<fmt:message key=" max.iops.required " bundle="${msg} " />' }}" class="fa fa-warning error-icon"></i>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row border-content">
        <div class="col-md-12 col-sm-12">
            <div class="row  form-group" data-ng-class="{ 'text-danger' : instanceForm.networkoffer.$invalid && OfferingSubmitted}">
                <div class="col-md-5 col-xs-5 col-sm-5">
                    <div class="pull-left m-r-xs m-t-xxs" data-ng-show="instanceForm.networkOfferinglist.$valid">
                        <a ng-click="computeSlide(); diskSlide(); networkSlide();"> <span data-ng-hide="networks" class="pe pe-lg pe-7s-plus"></span> <span data-ng-show="networks" class="pe pe-lg pe-7s-less"></span>
                        </a>
                    </div>
                    <label class="section-title">
                        <fmt:message key="common.network" bundle="${msg}" /><span title="<fmt:message key=" common.required " bundle="${msg} " />" class="text-danger font-bold">*</span>
                    </label>
                </div>
                <div class="col-md-6 col-xs-6 col-sm-6">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="table-responsive m-t-md">
                            ...
                            <table cellspacing="1" cellpadding="1" class="table table-bordered table-striped">
                                <tbody>
                                    <tr>
                                        <td><b><fmt:message key="network.name"
													bundle="${msg}" /><span
												title="<fmt:message key="common.required" bundle="${msg}" />"
												class="text-danger font-bold">*</span></b>
                                        </td>
                                        <td>
                                            <input type="text" class="input-small " data-ng-model="guestnetwork.name" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="35%">
                            ...
                            <button class="btn btn-info btn-sm pull-right" type="button" data-ng-click=addnetwork()>
                        ...
                        <div class="table-responsive m-t-md" style="height: 206px; overflow-y: auto; overflow-x: hidden;">
                            <table cellspacing="1" cellpadding="1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>
                                            <fmt:message key="common.network" bundle="${msg}" />
                                        </th>
                                        <th>
                                            <fmt:message key="common.type" bundle="${msg}" />
                                        </th>
                                        <th>
                                            <fmt:message key="common.action" bundle="${msg}" />
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
