...
<div class="row border-content">
		...
		<div class="row form-group required"
			...
			<div class="col-md-5 col-xs-5 col-sm-5">
				<div class="pull-left m-r-xs m-t-xxs"
					data-ng-show="computes && instance.computeOffering.isCustom == 'somes'">
			...
			<div class="col-md-6 col-xs-6 col-sm-6">
				<select required="true" class="form-control form-group-lg"
					...
					ng-change='computeFunction(instance.computeOffering.name)'
				...
				<input required="true" type="hidden" name="computeoffer"
					data-ng-model="instance.computeOffering.name" class="form-control"
	...
	<div
		data-ng-show="compute  && instance.computeOffering.isCustom == 'somes'">
			...
			<div class="col-md-3 col-sm-3 digit-2-width">
				<div class="input-group">
					<input class="form-control" name="ram" valid-number
						...
						class="input-group-addon" id="basic-addon2">GB</span>
				</div>
			</div>
		</div>
		<div class="row m-b-xl"
