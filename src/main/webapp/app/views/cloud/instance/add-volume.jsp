			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group"
						data-ng-class="{ 'text-danger' : volumeForm.name.$invalid && formSubmitted}">
						<div class="row">
							...
							<div class="col-md-5 col-xs-12 col-sm-5">
								...
								<i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon"
									tooltip="<fmt:message key="common.name" bundle="${msg}" />">
								</i>
					...
					<div class="form-group">
						<div class="row">
							<label class="col-md-3 col-xs-12 col-sm-2 control-label"><fmt:message key="common.type" bundle="${msg}" />
							...
							<div class="col-md-5 col-xs-12 col-sm-5">
								...
								<i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon"
									tooltip="<fmt:message key="common.type" bundle="${msg}" />">
								</i>
							</div>
						</div>
					</div>
					...
					<div class="form-group"
						...
						<div class="row">
							...
							<div class="col-md-5 col-xs-12 col-sm-5">
								...
								<i tooltip="<fmt:message key="common.plan" bundle="${msg}" />"
							...
							<div class="row">
								<div class="col-md-6 col-sm-6">
									<div class="form-group"
										...
										<label class="col-md-4 col-sm-4 control-label"><fmt:message key="min.iops" bundle="${msg}" />
								...
								<div class="col-md-6 col-sm-6">
									<div class="form-group"
										...
										<label class="col-md-4 col-sm-4 control-label"><fmt:message key="max.iops" bundle="${msg}" />
											<span class="text-danger">*</span>
										</label>
										<div class="col-md-5 col-sm-5">
											<input required="true"
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-5 col-xs-12 col-sm-5">
								...
								<input type="hidden" readonly="readonly" data-ng-model="volume.project"
			...
			<span class="pull-left" data-ng-if="volume.storageOffering.name">
				<input type="hidden" readonly="readonly" data-ng-model= "storageOfferCostSum" data-ng-bind= "storageOfferCostSum =
				  ...
				  <span data-ng-show="storageOfferCostSum > 0" class="text-danger price-text">
                       <app-currency></app-currency>{{storageOfferCostSum/30 | number:2 }}
                       <span> /
                           <fmt:message key="common.day" bundle="${msg}" />
                       </span>
                       <small class="text-muted">
                           (<app-currency></app-currency>{{storageOfferCostSum | number:2 }} / <fmt:message key="common.month" bundle="${msg}" />)
                       </small>
                  </span>
