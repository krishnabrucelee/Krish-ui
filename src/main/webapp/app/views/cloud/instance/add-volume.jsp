...
<form name="volumeForm" method="POST" data-ng-submit="save(volumeForm, volume)" novalidate >
                ...
                <div class="col-md-12">
                    ...
                    <div data-ng-show="volume.storageOffering.isCustomDisk">
                        <div class="form-group" ng-class="{ 'text-danger' : volumeForm.diskSize <= 0 && formSubmitted}">
                            <div class="row" >
                                <label class="col-md-3 col-xs-12 col-sm-2 control-label">Size (GB)
                                    <span class="text-danger">*</span>
                                </label>
   ...
   <%--                      <div data-ng-show="global.sessionValues.type != 'USER'">
                            <label class="col-md-3 col-xs-12 col-sm-2 control-label control-normal"><fmt:message key="common.department" bundle="${msg}" />    <span class="text-danger">*</span></label>
                                <div class="col-md-5 col-xs-12 col-sm-5"> {{instance.department.type}}
                                    <select required="true" class="form-control input-group" name="department" data-ng-model="volume.department"

                                    ng-options="instance.department.userName for department in volumeElements.departmentList" data-ng-class="{'error': volumeForm.department.$invalid && formSubmitted}" >
                                        <option value=""><fmt:message key="common.select" bundle="${msg}" /></option>
...
<%--            			<div class="form-group" >
           ...
           <div class="form-group" >
                        <div class="row">
                            <label class="col-md-3 col-xs-12 col-sm-2 control-label control-normal"><fmt:message key="common.project" bundle="${msg}" /> <span class="m-l-xs"></span></label>
                            <div class="col-md-5 col-xs-12 col-sm-5">
