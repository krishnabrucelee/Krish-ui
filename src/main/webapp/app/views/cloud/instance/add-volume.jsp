...
<form name="volumeForm" method="POST" data-ng-submit="save(volumeForm, volume)" novalidate>
    <div class="inmodal">
        <div class="modal-header">
            <panda-modal-header page-icon="fa fa-database" page-title="<fmt:message key=" add.volume " bundle="${msg} " />">
            </panda-modal-header>
        </div>
                ...
                <div class="col-md-12">
                        ...
                        <div class="form-group" data-ng-class="{ 'text-danger' : volumeForm.diskSize <= 0 && volumeForm.diskSize.$invalid && formSubmitted}">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-12 col-sm-3">
                                    <input type="text" data-ng-min="{{ volumeElements.diskOffer.diskSize.floor }}" data-ng-max="{{ volumeElements.diskOffer.diskSize.ceil}}" class="form-control input-mini" name="diskSize" data-ng-model="volume.diskSize" valid-number="">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group" data-ng-class="{ 'text-danger' : volumeForm.diskMinIops <= 0 && OfferingSubmitted}">
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <input class="form-control ng-pristine ng-valid ng-touched" type="text" data-ng-model="volume.diskMinIops" valid-number="" name="diskMinIops">
                                            <div class="error-area" data-ng-show="volumeForm.diskMinIops.$invalid && formSubmitted">
                                                <i ng-attr-tooltip="{{ volumeForm.diskMinIops.errorMessage || '<fmt:message key=" max.iops.required " bundle="${msg} " />' }}" class="fa fa-warning error-icon"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group" data-ng-class="{ 'text-danger' : volumeForm.diskMaxIops <= 0 && OfferingSubmitted}">
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <input class="form-control ng-pristine ng-valid ng-touched" type="text" data-ng-model="volume.diskMaxIops" valid-number="" name="diskMaxIops">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-xs-12 col-sm-5">
                                <label>{{ instance.project.name }}</label>
                                <input type="hidden" readonly="readonly" data-ng-model="volume.project" data-ng-init="volume.project=instance.project" />
                            </div>
                        </div>
                    </div>
                </div>
