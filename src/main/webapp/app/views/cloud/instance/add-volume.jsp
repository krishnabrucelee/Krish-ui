...
<form name="volumeForm" method="POST"
	data-ng-submit="save(volumeForm, volume)" novalidate>
	<div class="inmodal">
		<div class="modal-header">
			<panda-modal-header page-icon="fa fa-database"
				page-title="<fmt:message key="add.volume" bundle="${msg}" />"></panda-modal-header>
		</div>
		<div class="modal-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group"
						ng-class="{ 'text-danger' : volumeForm.name.$invalid && formSubmitted}">
						<div class="row">
							<label class="col-md-3 col-xs-12 col-sm-2 control-label"><fmt:message
									key="common.name" bundle="${msg}" /> <span class="text-danger">*</span>
							</label>
							<div class="col-md-5 col-xs-12 col-sm-5">
								<input required="true" type="text" name="name"
									data-ng-model="volume.name" class="form-control"
									data-ng-class="{'error': volumeForm.name.$invalid && formSubmitted}">
								<i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon"
									tooltip="<fmt:message key="common.name" bundle="${msg}" />"></i>
								<div class="error-area"
									data-ng-show="volumeForm.name.$invalid && formSubmitted">
					...
					<div class="form-group">
						<div class="row">
							<label class="col-md-3 col-xs-12 col-sm-2 control-label"><fmt:message
									key="common.type" bundle="${msg}" /> <span class="m-l-xs"></span></label>
							<div class="col-md-5 col-xs-12 col-sm-5">
								<select class="form-control input-group"
									name="diskOfferingsTags" data-ng-model="volume.storageTags"
								...
								<i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon"
									tooltip="<fmt:message key="common.type" bundle="${msg}" />"></i>

							</div>
						</div>
					</div>
					<div class="form-group"
						ng-class="{ 'text-danger' : volumeForm.diskOfferings.$invalid && formSubmitted}">
						<div class="row">
							<label class="col-md-3 col-xs-12 col-sm-2 control-label"><fmt:message
									key="common.plan" bundle="${msg}" /> <span class="text-danger">*</span>
							</label>
							<div class="col-md-5 col-xs-12 col-sm-5">
								<select required="true" class="form-control input-group"
									name="diskOfferings" data-ng-model="volume.storageOffering"
									...
									<option value=""><fmt:message key="common.select"
											bundle="${msg}" /></option>
								</select> <i tooltip="<fmt:message key="common.plan" bundle="${msg}" />"
					...
					<div data-ng-show="volume.storageOffering.isCustomDisk">
						<div class="form-group"
							ng-class="{ 'text-danger' : volumeForm.diskSize <= 0 && volumeForm.diskSize.$invalid && formSubmitted}">
							<div class="row">
								<label class="col-md-3 col-xs-12 col-sm-2 control-label"><fmt:message
										key="common.size" bundle="${msg}" /> <fmt:message
										key="common.gb" bundle="${msg}" /> <span class="text-danger">*</span>
								</label>
						...
						<div class="form-group"
							ng-class="{ 'text-danger' : volumeForm.diskMinIops.$invalid && formSubmitted}"
							data-ng-show="volume.storageOffering.isCustomizedIops">
							<div class="row">
								<div class="col-md-6 col-sm-6">
									<div class="form-group"
										ng-class="{ 'text-danger' : volumeForm.diskMinIops <= 0 && OfferingSubmitted}">
										...
										<div class="col-md-5 col-sm-5">
											...
											<div class="error-area"
												...
												<i ng-attr-tooltip="{{ volumeForm.diskMinIops.errorMessage || '<fmt:message key="max.iops.required" bundle="${msg}" />' }}"
													class="fa fa-warning error-icon"></i>
											</div>
										</div>
									</div>
								...
								<div class="col-md-6 col-sm-6">
									<div class="form-group"
										ng-class="{ 'text-danger' : volumeForm.diskMaxIops <= 0 && OfferingSubmitted}">
										<label class="col-md-3 col-sm-3 control-label"><fmt:message
										...
										<div class="col-md-5 col-sm-5">
											...
											<div class="error-area"
												data-ng-show="volumeForm.diskMaxIops.$invalid && formSubmitted">
					...
					<div class="form-group"
						ng-class="{ 'text-danger' : volumeForm.department.$invalid && formSubmitted}">
						<div class="row">
							<div>
								<label
									class="col-md-3 col-xs-12 col-sm-2 control-label control-normal"><fmt:message
										key="common.department" bundle="${msg}" /> </label>
								<div class="col-md-5 col-xs-12 col-sm-5">
									<label>{{ instance.department.userName }}</label> <input
										type="hidden" readonly="readonly"
										data-ng-model="volume.department"
										data-ng-init="volume.department=instance.department" />
								</div>
							</div>
					...
					<div class="form-group">
						<div class="row">
							<label
								class="col-md-3 col-xs-12 col-sm-2 control-label control-normal"><fmt:message
									key="common.project" bundle="${msg}" /> <span class="m-l-xs"></span></label>
							<div class="col-md-5 col-xs-12 col-sm-5">
								<label>{{ instance.project.name }}</label> <input type="hidden"
									readonly="readonly" data-ng-model="volume.project"
									data-ng-init="volume.project=instance.project" />
							</div>
						</div>
					</div>
				</div>
		...
		<div class="modal-footer">
			...
			<a class="btn btn-default" data-ng-hide="showLoader"
				data-ng-click="cancel()"><fmt:message key="common.cancel"
					bundle="${msg}" /></a>
