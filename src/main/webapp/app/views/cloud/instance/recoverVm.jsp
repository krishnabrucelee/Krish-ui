...
<form name="form.detachForsm">
    <div class="inmodal" >
        ...
        <div class="modal-body">
            <div class=" row">
                ...
                <div class="form-group has-error col-md-9 col-sm-9  col-xs-9 m-t-md">
                    <p >Please confirm that you would like to recover this VM.</p>
                </div>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-default btn-danger2" ng-click="vmRecover(item)" data-dismiss="modal">Ok</button>
