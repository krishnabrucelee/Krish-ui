                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <div class="row-fluid">
                                                                    ...
                                                                    <div data-ng-if="nic.vmInstance.publicIpAddress" class=""><label class="headerLabel m-r-xs"><fmt:message key="public.ip" bundle="${msg}" />:</label><span>{{nic.vmInstance.publicIpAddress}}</span></div>
