                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <div class="row-fluid">
                                                                    ...
                                                                    <div class="pull-right">
									<span class="pull-right m-l-sm m-t-sm"> <a class="btn btn-info" ui-sref="cloud.list-instance.view-instance.view-ipaddress({id1:nic.id})"><fmt:message key="edit.secondary.ips" bundle="${msg}" /></a>
									</span>
								</div>
