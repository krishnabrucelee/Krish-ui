...
<form name="form.detachForsm">
    <div class="inmodal" >
        <div class="modal-header">
            <panda-modal-header hide-zone="false" page-icon="fa fa-play" page-title="Start Instance"></panda-modal-header>
        ...
        <div class="modal-body">
            <div class=" row">
                ...
                <div class="form-group has-error col-md-9 col-sm-9  col-xs-9 m-t-md">
                    <p >Please confirm that you want to start this instance.</p>
                </div>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-default btn-danger2" ng-click="vmStart(item)" data-dismiss="modal">Ok</button>
