                                ...
                                <ul class="list-group">
                                    <div data-ng-if="instance.status != 'ERROR' || instance.status != 'EXPUNGING' || instance.status != 'STARTING' || instance.status != 'STOPPING' || instance.status != 'DESTROYING'">
                                        ...
                                        <li has-permission="ATTACH_ISO" class="list-group-item">
                                            <button ng-class = "(instance.status == 'RUNNING' || instance.status == 'STOPPED') && !instance.isoName ? 'resizelink enable' : 'resizelink disable'" data-ng-disabled=" (instance.status == 'RUNNING' || instance.status == 'STOPPED') && instance.isoName " href="javascript:void(0);" title="<fmt:message key="attach.iso" bundle="${msg}" />" data-ng-click="attachISO(instance)"><span class="m-xs"><img src="images/attach.png" border="0"/></span> <fmt:message key="attach.iso" bundle="${msg}" /></button>
                                        </li>
                                        <li has-permission="ATTACH_ISO" class="list-group-item" data-ng-if="instance.isoName">
                                            <button ng-class = "(instance.status == 'RUNNING' || instance.status == 'STOPPED') && instance.isoName ? 'resizelink enable' : 'resizelink disable'" data-ng-disabled = "(instance.status == 'RUNNING' || instance.status == 'STOPPED') && !instance.isoName" href="javascript:void(0);" title="<fmt:message key="detach.iso" bundle="${msg}" />" data-ng-click="detachISO(instance)"><span class="m-xs"><img src="images/detach.png" border="0"/></span> <fmt:message key="detach.iso" bundle="${msg}" /></button>
                                            <span>{{instance.isoName}}</span>
