...
<div class="inmodal" >
    ...
    <div class="modal-body">
        <div class=" row">
            ...
            <div class="form-group has-error col-md-9 col-sm-9  col-xs-9 m-t-md">
                <p ><fmt:message key="are.you.sure.do.you.want.to.make.this.network.as.default" bundle="${msg}" /> </p>
            </div>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-default btn-danger2" ng-click="ok(network)" data-dismiss="modal"><fmt:message key="common.ok" bundle="${msg}" /></button>
