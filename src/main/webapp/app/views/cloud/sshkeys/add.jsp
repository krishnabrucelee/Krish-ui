					...
					<div class="form-group" ng-class="{'text-danger': sshkeyForm.name.$invalid && formSubmitted}">
						<div class="row">
							...
							<div class="col-md-6 col-xs-12 col-sm-6">
								<input required="true" ng-minlength="1" ng-maxlength= "30" type="text" name="name" data-ng-model="sshkey.name" class="form-control" data-ng-class="{'error': sshkeyForm.name.$invalid && formSubmitted}">
								<span style="color:red" ng-show="sshkeyForm.name.$error.minlength "><fmt:message key="your.name.should.contain.atleast.1.characters" bundle="${msg}" /></span>
