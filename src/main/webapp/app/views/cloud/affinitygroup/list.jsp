                    ...
                    <form data-ng-submit="searchList(affinityGroupSearch)">
                            <div class="quick-search pull-right m-r-sm">
								<div class="input-group">
									<input data-ng-model="affinityGroupSearch" id="affinity_group_list_search" type="text" class="form-control input-medium" placeholder="<fmt:message key="common.quick.search" bundle="${msg}" />" aria-describedby="quicksearch-go">
