                        ...
                        <tbody>
                            <tr data-ng-repeat="snapshot in vmSnapshotList | filter:quickSearch">
                                ...
                                <td>
                                 ...
                                 <td>
                                    <a class="icon-button" title="<fmt:message key="restore.vm.snapshot" bundle="${msg}" />"  data-ng-click="restoresnapshot(vmsnapshot)()">
                                        <span class="fa fa-rotate-left "> </span>
                                    </a>
                                    <a class="icon-button" title="<fmt:message key="delete.vm.snapshot" bundle="${msg}" />" data-ng-click="deleteSnapshot('sm', vmsnapshot)()"><span class="fa fa-trash"></span></a>
