...
<div class="inmodal" data-ng-contoller="networksCtrl">
        ...
        <div class="row">
           ...
           <label class="control-label ">Algorithm</label>
            ...
            <div class=" col-md-6 col-sm-6  col-xs-6 ">
             <div class="form-group row">
             <input type="text" name="name" data-ng-model="rule.name"  class="form-control" >
    ...
    <div class="modal-footer">
        ...
        <button type="button" data-ng-hide="showLoader" class="btn btn-info "   ng-click="" data-dismiss="modal"><fmt:message key="common.update" bundle="${msg}" /></button>
