...
<form name="addnetworkForm" data-ng-submit="update(addnetworkForm)"
			...
			<div class="hpanel">
				...
				<div class="pull-right m-r-sm">
					<select class="form-control" name="actions"
						data-ng-init="network.actions = networkElements.actions[3].name"
						data-ng-model="network.actions"
						ng-options="actions.name for actions in networkElements.actions">
						<option value="">Minutes</option>
					</select>
				</div>
				<div class="clearfix"></div>
				<div class="chart">
					<canvas linechart options="lineOptions" data="lineData" width="800"
						height="150"></canvas>
				</div>
				<table>
					<tbody>
						<tr>
							<td class="legendColorBox p-xs">
								<div style="border: 1px solid #ccc; padding: 1px">
									<div
										style="width: 4px; height: 0; border: 5px solid #E56919; overflow: hidden"></div>
								</div>
							</td>
							<td class="legendLabel">B/W IN</td>
							<td class="legendColorBox p-xs"><div
									style="border: 1px solid #ccc; padding: 1px">
									<div
										style="width: 4px; height: 0; border: 5px solid #16658D; overflow: hidden"></div>
								</div></td>
				...
				<div class="panel-body no-padding">
					<ul class="list-group">
						 <li class="list-group-item">
                            <a href="javascript:void(0);" title=" <fmt:message key="restart.network" bundle="${msg}" /> " data-ng-click="restart('sm', network.id)" ><span class="fa-repeat fa font-bold m-xs"></span><fmt:message key="restart.network" bundle="${msg}" /></a>
                        </li>
						...
						<li data-ng-if="type != 'edit'" class="list-group-item"><a
							...
							href="#/network/list/edit/{{ network.id}}"> <span
