        ...
        <table cellspacing="1" cellpadding="1" class="table table-bordered table-striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td data-ng-if="firewallRules.protocol == 'ICMP'"><input valid-number   name="icmpMessage" required="true" data-ng-model="firewallRules.icmpMessage" class="form-control " autofocus type="text"><span class="text-center text-danger" data-ng-show="egressForm.icmpMessage.$invalid && formSubmitted"> *Required</span></td>
                    <td data-ng-if="firewallRules.protocol == 'ICMP'"><input valid-number  name="icmpCode" required="true" data-ng-model="firewallRules.icmpCode" class="form-control " autofocus type="text"><span class="text-center text-danger" data-ng-show="egressForm.icmpCode.$invalid && formSubmitted"> *Required</span></td>
                    <td>
