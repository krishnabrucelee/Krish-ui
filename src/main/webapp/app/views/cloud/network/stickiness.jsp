...
<form name="stickinessForm"
	...
	<div class="inmodal">
		<div class="modal-header">
			<panda-modal-header hide-zone="false" page-icon="fa fa-plus-circle"
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="form-group"
							...
							data-ng-show="stickiness.stickinessMethod == 'SourceBased' || stickiness.stickinessMethod == 'AppCookie'">
							<div class="row">
								<label class="col-md-3 col-xs-12 col-sm-3 control-label"><fmt:message
										key="sticky.name" bundle="${msg}" /> <span
									class="text-danger">*</span></label>
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input required="true" type="text" name="stickyName"
						...
						<div class="form-group"
							...
							<div class="row">
								...
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input type="text" name="tableSize"
						...
						<div class="form-group"
							...
							<div class="row">
								...
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input icheck data-ng-model="stickiness.stickyRequestLearn"
						...
						<div class="form-group"
							...
							<div class="row">
								...
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input icheck data-ng-model="stickiness.stickyPrefix"
						...
						<div class="form-group"
							...
							<div class="row">
								...
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input icheck data-ng-model="stickiness.stickyNoCache"
						...
						<div class="form-group"
							...
							<div class="row">
								...
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input icheck data-ng-model="stickiness.stickyIndirect"
						...
						<div class="form-group"
							...
							<div class="row">
								...
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input icheck data-ng-model="stickiness.stickyPostOnly"
