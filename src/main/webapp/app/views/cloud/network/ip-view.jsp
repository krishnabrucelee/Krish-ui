...
<div class="row m-l-sm m-r-sm panel-body" data-ng-controller="networksCtrl" >
    ...
    <ul class="nav nav-tabs" data-ng-init="templateCategory = tabview">
        ...
        <li data-ng-class="{'active' : tabview == 'firewall'}"><a  data-ng-click="firewallRule(1)" data-toggle="tab"><i class="custom-icon custom-firewall-ip"></i> <fmt:message key="firewall" bundle="${msg}" /></a></li>
        <li data-ng-if = "!ipDetails.isStaticnat" data-ng-class="{'active' : tabview == 'port-forward'}"><a  data-ng-click="portRulesLists(1)" data-toggle="tab"> <i class="fa fa-mail-forward"></i> <fmt:message key="port.forwarding" bundle="${msg}" /></a></li>
        <li data-ng-if = "!ipDetails.isStaticnat" data-ng-class="{'active' : tabview == 'load-balance'}"><a data-ng-click="LBlist(1)" data-toggle="tab"> <i class="custom-icon custom-load-ip"></i> <fmt:message key="load.balancing" bundle="${msg}" /></a></li>
