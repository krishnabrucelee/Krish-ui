        ...
        <table cellspacing="1" cellpadding="1" class="table table-bordered table-striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td><select required="true" class="form-control input-group" name="protocol" data-ng-model="protocolName" data-ng-init="protocolName = networkLists.portProtocols[0]" data-ng-change="selectProtocol(protocolName.name)" data-ng-options="protocolName.name for protocolName in networkLists.portProtocols"></select>   </td>
          ...
          <thead>
            ...
            <tbody>
               <tr ng-repeat="rule in portList" class="font-bold text-center">
                   <td><div class="col-xs-6">{{rule.startPort}}</div><div class="col-xs-6">{{rule.endPort}}</div> </td>
                <td><div class="col-xs-6">{{rule.startPort}}</div><div class="col-xs-6">{{rule.endPort}}</div> </td>
