<form name="volumeForm" method="POST" data-ng-submit="save(volumeForm)" novalidate  data-ng-controller="volumeCtrl">
    <div class="inmodal" >
                            ...
                            <div class="row" > 
                                ...
                                <div class="col-md-2 col-xs-12 col-sm-3">
                                    <input type="text" valid-number  data-ng-min="{{ volumeElements.diskOffer.iops.floor}}" data-ng-max="{{ volumeElements.diskOffer.iops.ceil}}"
                                           class="form-control input-mini" name="volumeElements.diskOffer.iops.value" data-ng-model="volumeElements.diskOffer.iops.value" data-ng-change="volumeElements.diskOffer.iops.value = volumeElements.diskOffer.iops.value">
                                </div>
                            </div>
                        </div>
                        <!--<div class="hr-line-dashed"></div>-->
