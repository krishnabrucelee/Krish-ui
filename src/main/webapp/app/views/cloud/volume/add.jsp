						...
						<div class="form-group"
							...
							<div class="row">
								<div class="col-md-6 col-sm-6">
									<div class="form-group"
										data-ng-class="{ 'text-danger' : volumeForm.diskMinIops <= 0 && OfferingSubmitted}">
								...
								<div class="col-md-6 col-sm-6">
									<div class="form-group"
										data-ng-class="{ 'text-danger' : volumeForm.diskMaxIops <= 0 && OfferingSubmitted}">
										<label class="col-md-4 col-sm-4 control-label"><fmt:message
							...
							<div data-ng-show="global.sessionValues.type != 'USER'">
								...
								<div class="col-md-5 col-xs-12 col-sm-5">
									...
									<div class="error-area"
										...
										<i
											ng-attr-tooltip="{{ volumeForm.department.errorMessage || '<fmt:message key="department.is.required" bundle="${msg}" />' }}"
											class="fa fa-warning error-icon"></i>
									</div>
								</div>
							</div>
							...
							<div data-ng-if="global.sessionValues.type != 'USER'">
								...
								<div class="col-md-5 col-xs-12 col-sm-5">
									...
									<i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon"
										tooltip="<fmt:message key="common.project" bundle="${msg}" />"></i>
