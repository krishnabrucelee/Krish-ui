                                            ...
                                            <span data-ng-if="volume.volumeType == 'DATADISK'">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <img src="images/dropdown-arw2.png" border="0" class="vol-dropdown-arw">
                                                     <li has-permission = "DISK_SNAPSHOT"><a class="icon-button" href="javascript:void(0);" data-ng-click="createSnapshot(md, volume)" title="<fmt:message key="common.snapshot" bundle="${msg}" />"><span class="fa fa-camera m-xs"></span> <fmt:message key="common.snapshot" bundle="${msg}" /></a></li>
                                                    <li has-permission = "RECURRING_SNAPSHOT"><a href="javascript:void(0);" data-ng-click="openReccuringSnapshot(volume)" title="<fmt:message key="recurring.snapshot" bundle="${msg}" />"><span class="fa fa-repeat m-xs"></span> <fmt:message key="recurring.snapshot" bundle="${msg}" /></a></li>
...
<%--                                                     <li><a href="javascript:void(0);" title="Download Volume" data-ng-click="downloadVolume('md')"><span class="fa fa-cloud-download m-xs"></span> <fmt:message key="download.volume" bundle="${msg}" /></a></li>
 ...
 --%>                                                    <li has-permission="DELETE_VOLUME"><a href="javascript:void(0);" data-ng-hide="volume.vmInstanceId > 0" data-ng-click="delete('sm', volume)" title="<fmt:message key="delete.volume" bundle="${msg}" />"><span class="fa fa-trash m-xs"></span><fmt:message key="delete.volume" bundle="${msg}" /> </a></li>
                                                </ul>
                                            </span>
                                             <span data-ng-if="volume.volumeType == 'ROOT'">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <img src="images/dropdown-arw2.png" border="0" class="vol-dropdown-arw">
                                                    <li has-permission = "DISK_SNAPSHOT"><a href="javascript:void(0);" data-ng-click="createSnapshot(md, volume)" title="<fmt:message key="common.snapshot" bundle="${msg}" />"><span class="fa fa-camera m-xs"></span> <fmt:message key="common.snapshot" bundle="${msg}" /></a></li>
                                                    <li has-permission = "RECURRING_SNAPSHOT" ><a href="javascript:void(0);" data-ng-click="openReccuringSnapshot(volume)"  title="<fmt:message key="recurring.snapshot" bundle="${msg}" />"><span class="fa fa-repeat m-xs"></span> <fmt:message key="recurring.snapshot" bundle="${msg}" /></a></li>
                                                </ul>
                                            </span>
                                        </div>
