                                        ...
                                        <div class="btn-group action-menu">
                                            <span data-ng-if="volume.volumeType == 'DATADISK'">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    ...
                                                    <li><a href="javascript:void(0);" has-permission="ATTACH_DISK" data-ng-show="volume.vmInstanceId > 0" title="<fmt:message key="common.detach.volume" bundle="${msg}" />" data-ng-click="detach(md, volume)"><span class="fa fa-unlink m-xs"></span> <fmt:message key="detach.volume" bundle="${msg}" /></a></li>
                                                    <li><a href="javascript:void(0);" has-permission="DETACH_DISK" data-ng-hide="volume.vmInstanceId > 0" title="<fmt:message key="common.attach.volume" bundle="${msg}" />" data-ng-click="attach(md, volume)"><span class="pe-7s-disk pe-1x font-bold m-xs"></span> <fmt:message key="attach.volume" bundle="${msg}" /></a></li>
