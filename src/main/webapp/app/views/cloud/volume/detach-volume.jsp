...
<form name="form.detachForsm" >
    <div class="inmodal" >
        ...
        <get-loader-image data-ng-show="showLoader"></get-loader-image>
            ...
            <button type="submit" has-permission="DETACH_DISK" data-ng-hide="showLoader" class="btn btn-default btn-danger2" ng-click="detachVolume(volume)" data-dismiss="modal"><fmt:message key="common.ok" bundle="${msg}" /></button>
        </div>
    </div>
</form>