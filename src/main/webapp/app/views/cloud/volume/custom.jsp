<div class="hpanel"> 
    <div class="panel-body">
        ...
        <div class="form-group" ng-class="{'text-danger': volumeCustomForm.name.$invalid && formSubmitted.custom}">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <span class="help-block m-b-none" ng-show="volumeCustomForm.name.$invalid && formSubmitted.custom" >Name is required.</span>
                </div>
                <div class="col-md-5 tooltip-container">
        ...
        <div class="hr-line-dashed"></div>
        <div class="form-group" ng-class="{ 'text-danger' : volumeCustomForm.diskOffering.$invalid && formSubmitted.custom}">
            ...
            <div class="row" > 
                ...
                <div class="col-md-3 col-sm-3">
                    <div class="input-group">
                        <input type="text" class="form-control input-mini" name="volumeCustomForm.diskOffer.diskSize.value" data-ng-model="volumeElements.diskOffer.diskSize.value">
