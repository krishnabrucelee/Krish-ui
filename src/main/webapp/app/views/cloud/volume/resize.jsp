<form name="volumeForm" method="POST" data-ng-submit="save(volumeForm)" novalidate >
    <div class="inmodal" >
        <div class="modal-header">
            <panda-modal-header page-icon="fa fa-expand" page-title="Resize Volume"></panda-modal-header>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group" ng-class="{ 'text-danger' : volumeForm.name.$invalid && formSubmitted}">
                        <div class="row">
                            <label class="col-md-3 col-xs-12 col-sm-3 control-label">{{ selectedVolume}}Name </label>
                            <div class="col-md-5 col-xs-12 col-sm-5">
                                <input required="true" readonly="readonly" type="text" name="name" data-ng-model="volume.name" class="form-control" data-ng-class="{'error': volumeForm.name.$invalid && formSubmitted}" >
                            ...
                            <div class="col-md-9 col-xs-12 col-sm-9">
                                <div class="btn-group" data-toggle="buttons"> 
                                    <label data-ng-init="volume.type = volumeElements.type[0]" data-ng-click="resetDiskValues(volumeType)"
                                           class="btn m-r-md m-t-sm w-sm" data-ng-class="volume.type.id == volumeType.id ? 'btn-info' : 'btn - default'" data-ng-repeat="volumeType in volumeElements.type">
                                        {{ volumeType.name}}
                                    </label> 
                    ...
                    <div class="form-group" ng-class="{ 'text-danger' : volumeForm.diskOfferings.$invalid && formSubmitted}">
                        ...
                        <div class="row" > 
                            <label class="col-md-3 col-xs-12 col-sm-3 control-label">Plan 
                    ...
                    <div data-ng-show="volume.diskOfferings.custom">
                        <div class="form-group" ng-class="{ 'text-danger' : volumeForm.diskOffering.$invalid && formSubmitted.dynamic}">
