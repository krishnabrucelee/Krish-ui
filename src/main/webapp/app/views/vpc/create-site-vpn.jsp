...
<div class="inmodal" data-ng-contoller="vpcCtrl">
    <div class="modal-header">
        <panda-modal-header id="delete_vpc_page_title" hide-zone="false" page-icon="fa fa-check-square" page-title="<fmt:message key="common.confirmation" bundle="${msg}" />"></panda-modal-header>
    </div>
    <div class="modal-body">
        ...
        <div class="form-group has-error col-md-2 col-sm-2  col-xs-2">
            ...
            <div class="form-group col-md-10 col-sm-10  col-xs-10">
                <p ><fmt:message key="common.vpn.create.confirmation" bundle="${msg}" /></p>
            </div>
        </div>
    </div>
