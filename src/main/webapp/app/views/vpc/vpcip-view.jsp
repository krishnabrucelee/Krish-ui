...
<div class="row m-l-sm m-r-sm panel-body" data-ng-controller="vpcCtrl" >
    ...
    <ul class="nav nav-tabs" data-ng-init="templateCategory = tabview">
        ...
        <li data-ng-if = "!ipDetails.isStaticnat && !ipDetails.isSourcenat" data-ng-class="{'active' : tabview == 'load-balance'}"><a data-ng-click="templateCategory = 'load-balance'" data-toggle="tab"> <i class="custom-icon custom-load-ip"></i> Load Balancing</a></li>
