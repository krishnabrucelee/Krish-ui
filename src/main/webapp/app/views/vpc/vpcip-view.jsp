...
<div class="row m-l-sm m-r-sm panel-body" data-ng-controller="vpcCtrl" >
    ...
    <ul class="nav nav-tabs" data-ng-init="templateCategory = tabview">
        ...
        <li data-ng-hide="type =='source'" data-ng-class="{'active' : tabview == 'port-forward'}"><a  data-ng-click="portRulesLists(1)" data-toggle="tab"> <i class="fa fa-mail-forward"></i> Port Forwarding</a></li>
        <li data-ng-hide="type =='source'" data-ng-class="{'active' : tabview == 'load-balance'}"><a data-ng-click="templateCategory = 'load-balance'" data-toggle="tab"> <i class="custom-icon custom-load-ip"></i> Load Balancing</a></li>
        <li data-ng-hide="type !='source'" data-ng-class="{'active' : tabview == 'vpn-details'}"><a data-ng-click="templateCategory = 'vpn-details'" data-toggle="tab"> <i class="custom-icon custom-icon-ip"></i> VPN</a></li>
    </ul>
