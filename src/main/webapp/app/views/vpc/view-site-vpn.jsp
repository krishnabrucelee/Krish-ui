								...
								<table cellspacing="1" cellpadding="1" class="table table-bordered table-striped" id="vpn_site_gateway_table">
								    ...
								    <tbody data-ng-show="sitevpnList.length > 0">
								         <tr ng-repeat="vpn in sitevpnList">
                      					...
                      					<td>
                      					    <a class="icon-button test_vpc_delete_button" id="vpn_delete_button_{{vpn.id}}" data-ng-click="viewsitevpn('sm')"  ><span class="fa fa-eye"></span></a>
                          					<a has-permission="DELETE_VPC" class="icon-button test_vpc_delete_button" id="vpc_delete_button_{{vpc.id}}" data-ng-click="deletevpn('sm', vpn)"  ><span class="fa fa-trash"></span></a>
                       					</td>
              							</tr>
