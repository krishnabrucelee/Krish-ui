...
<div class="inmodal" >
    ...
    <get-loader-image data-ng-show="showLoader"></get-loader-image>
        ...
        <button type="button" data-ng-hide="showLoader" class="btn btn-default btn-danger2" ng-click="ok(networkAcl)" data-dismiss="modal"><fmt:message key="common.ok" bundle="${msg}" /></button>
