							...
							<div class="table-responsive">
								<table cellspacing="1" cellpadding="1" class="table table-bordered table-striped">
								    ...
								    <tbody>
								        <tr>
								            <td>
								                <a class="text-info" ui-sref="vpc.view-vpc({id: {{ 1}}})">myfirstVPC1</a>
								            </td>
								            <td>Test VPC 1</td>
								            <td>devpanda-zone</td>
								            <td>10.0.0.0/22</td>
								            <td><label class="label label-success text-center text-white">ENABLED</label></td>
								            <td>
								                <a class="icon-button" title="Configure" ui-sref="vpc.config-vpc({id: {{ 1}}})">
								                    <span class="fa fa-cog m-r"> </span>
								                </a>
								                 <a class="icon-button" title="Restart VPC">
								                	<span class="fa fa-rotate-left m-r"></span>
								                </a>
								                <a class="icon-button" title="Remove VPC"  ><span class="fa fa-trash"></span></a>
								            </td>
								        </tr>
								        <tr>
								            <td>
