                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="pull-right dashboard-filters-area" id="vpc_quick_search">
						<form data-ng-submit="searchList(vpcSearch)">
							...
							<input data-ng-model="vpcSearch" id="vpc_list_search" type="text" class="form-control input-medium" placeholder="<fmt:message key="common.quick.search" bundle="${msg}" />" aria-describedby="quicksearch-go">
