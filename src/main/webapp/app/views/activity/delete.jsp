...
<form name="deleteForm" method="POST" data-ng-submit="remove(deleteForm)" novalidate  data-ng-controller="deleteCtrl">
    <div class="inmodal" >
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group" ng-class="{'text-danger': deleteForm.type.$invalid && formSubmitted}">
                        <div class="row">
                            <label  class="col-md-3 col-xs-12 col-sm-2 control-label"><fmt:message key="by.type" bundle="${msg}" />
                            </label>
                            <div class="col-md-5 col-xs-12 col-sm-5">
                                ...
                                <div class="error-area" data-ng-show="deleteForm.type.$invalid && formSubmitted" ><i  tooltip="<fmt:message key="type.is.required" bundle="${msg}" />" class="fa fa-warning error-icon"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group" ng-class="{'text-danger': deleteForm.startDate.$invalid && formSubmitted}">
                        <div class="row">
                            <label  class="col-md-3 col-xs-12 col-sm-2 control-label"><fmt:message key="by.date" bundle="${msg}" /> (<fmt:message key="start" bundle="${msg}" />)
                            </label>
                            <div class="col-md-5 col-xs-12 col-sm-5">
                                <p class="input-group">
                                ...
                                <div class="error-area" data-ng-show="deleteForm.startDate.$invalid && formSubmitted" ><i  tooltip="<fmt:message key="date.is.required" bundle="${msg}" />" class="fa fa-warning error-icon"></i></div>
                    ...
                    <div class="form-group" ng-class="{'text-danger': deleteForm.endDate.$invalid && formSubmitted}">
                        <div class="row">
                            <label  class="col-md-3 col-xs-12 col-sm-2 control-label"><fmt:message key="by.date" bundle="${msg}" /> (<fmt:message key="end" bundle="${msg}" />)
                            </label>
                            <div class="col-md-5 col-xs-12 col-sm-5"> {{ $scope.dt}}
                                ...
                                <div class="error-area" data-ng-show="deleteForm.endDate.$invalid && formSubmitted" ><i  tooltip="<fmt:message key="date.is.required" bundle="${msg}" />" class="fa fa-warning error-icon"></i></div>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-info" type="submit"><fmt:message key="common.delete" bundle="${msg}" /></button>
        </div>
    </div>
</form>