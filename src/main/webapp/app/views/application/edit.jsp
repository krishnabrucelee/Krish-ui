...
<form name="applicationForm" data-ng-submit="update(applicationForm)" method="post" novalidate=""  >
    ...
    <div class="inmodal" >
        ...
        <div class="modal-footer">
            ...
            <button data-ng-if="!showLoader" type="button" class="btn btn-default " ng-click="cancel()" data-dismiss="modal"><fmt:message key="common.cancel" bundle="${msg}" /></button>
            <button data-ng-if="!showLoader" class="btn btn-info" type="submit"><fmt:message key="common.update" bundle="${msg}" /></button>
        </div>
        </div>
</form>
