...
<div id="navigation">
    <ul side-navigation class="nav" id="side-menu">
        ...
        <li data-ng-if="global.sessionValues.userStatus != 'SUSPENDED'" ng-class="{active: $state.includes('projects')}">
        ...
        <li data-ng-if="global.sessionValues.userStatus != 'SUSPENDED'" ng-class="{active: $state.includes('applications')}">
        ...
        <li data-ng-if="global.sessionValues.userStatus != 'SUSPENDED'" ng-class="{active: $state.includes('accounts')}">
         ...
         <li data-ng-if="global.sessionValues.userStatus != 'SUSPENDED'" ng-class="{active: $state.includes('roles')}">
