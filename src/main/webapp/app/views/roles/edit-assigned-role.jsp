...
<form name="RoleForm" data-ng-submit="editAssignedRoleSave(RoleForm)" method="post" novalidate="">
	...
	<div class="modal-header">
		<panda-modal-header page-icon="fa fa-user-plus" hide-zone="false" page-title="Edit Assigned Role"></panda-modal-header>
	</div>
            	...
            	<table cellspacing="1" cellpadding="1" class="table table-bordered table-striped ">
            		...
            		<tbody>
            			...
            			<tr data-ng-repeat="user in userList">
            				<td>{{user.userName}}</td>
            				<td>
          						<select class="form-control input-group" name="role" data-ng-model="userRoleList[user.id]" ng-options="role.name for role in roleList" data-ng-class="{'error': RoleForm.role.$invalid && formSubmitted}">
            						<option value=""><fmt:message key="common.select" bundle="${msg}" /></option>
            					</select>
            				</td>
            			</tr>
