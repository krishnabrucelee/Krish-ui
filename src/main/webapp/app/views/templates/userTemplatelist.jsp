						...
						<form data-ng-submit="searchList(vmSearch)">
							<div class="quick-search pull-right m-t-sm">
								<div class="input-group">
									<input data-ng-model="vmSearch" id="mytemplates_list_search" type="text" class="form-control input-medium" placeholder="<fmt:message key="common.quick.search" bundle="${msg}" />" aria-describedby="quicksearch-go">
