...
<input type="hidden" name="passwordErrorMessage" id="passwordErrorMessage" data-ng-model="account.passwordErrorMessage" value='<fmt:message key="please.check.confirm.password" bundle="${msg}" />' />
	...
	<div class="modal-header">
		<panda-modal-header page-icon="fa fa-user-plus" hide-zone="false" page-title=<fmt:message key="add.user" bundle="${msg}" />></panda-modal-header>
	</div>
                ...
                <div class="form-group" ng-class="{'text-danger': userForm.password.$invalid && formSubmitted}">
                	<div class="row">
                    	<label class="col-md-4 col-sm-4 control-label"><fmt:message key="common.password" bundle="${msg}" /><span class="text-danger">*</span>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input required="true" type="password" id="password" name="password" data-ng-model="user.password" class="form-control" data-ng-class="{'error': userForm.password.$invalid && formSubmitted}">
                         ...
                         <div class="form-group" ng-class="{'text-danger': userForm.confirmpassword.$invalid && formSubmitted}">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input required="true" type="password" id="confirmpassword" name="confirmpassword" data-ng-model="account.confirmPassword" class="form-control" data-ng-class="{'error': userForm.confirmpassword.$invalid && formSubmitted}">
                           ...
                           <div class="form-group" ng-class="{'text-danger': userForm.firstName.$invalid && formSubmitted}">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input required="true" type="text" name="firstName" data-ng-model="user.firstName" class="form-control" data-ng-class="{'error': userForm.firstName.$invalid && formSubmitted}">
                        ...
                        <div class="form-group" ng-class="{'text-danger': userForm.lastName.$invalid && formSubmitted}">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input required="true" type="text" name="lastName" data-ng-model="user.lastName" class="form-control" data-ng-class="{'error': userForm.lastName.$invalid && formSubmitted}">
                        ...
                        <div class="form-group" ng-class="{'text-danger': userForm.email.$invalid && formSubmitted}">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input required="true" type='email'  valid-email name="email" data-ng-model="user.email" class="form-control" data-ng-class="{'error': userForm.email.$invalid && formSubmitted}" >
                  ...
                  <div class="form-group" ng-class="{'text-danger':userForm.domain.$invalid && formSubmitted}">
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <select  required="true" class="form-control form-group-lg" name="domain"
                                             data-ng-model="user.domain"
                        ...
                        <div class="form-group"  ng-class="{'text-danger':userForm.role.$invalid && formSubmitted}">
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <select  required="true" class="form-control form-group-lg" name="role"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <select class="form-control form-group-lg" multiple="multiple" data-ng-model="user.projectList"
