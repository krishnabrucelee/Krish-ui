...
<div class="inmodal" >
    ...
    <div class="modal-footer">
        ...
        <button type="button" data-ng-hide="showLoader" class="btn btn-default btn-danger2" ng-click="deleteUsers(user)" data-dismiss="modal"><fmt:message key="common.ok" bundle="${msg}" /></button>
    </div>
</div>