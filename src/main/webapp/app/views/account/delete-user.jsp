<form name="form.detachForsm" data-ng-controller="accountListCtrl">
    <div class="inmodal" >
        <div class="modal-header">
            <panda-modal-header hide-zone="false" page-icon="fa fa-trash-o"   page-title="Delete Confirmation"></panda-modal-header>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-default btn-danger2" ng-click="deleteUsers()" data-dismiss="modal">Yes</button>
